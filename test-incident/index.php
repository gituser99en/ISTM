...
<div class="flex-cont">
<p>The Test Incident document allows testers to record all incidents that occur during testing activities. Its purpose is to capture risks, issues and possible process improvements.</p>
</div> 
...
<dl>
  <dt>Test Incident Document</dt>
  <dd>Create</dd>
  <dd>Insert</dd>
  <dd>Update</dd>
  <dd>Delete</dd>
  <dd>View by project</dd>
  <dd>View by status</dd>
  <dd>View by date</dd>
  <dd>Metrics</dd>
</dl>
...
<?php
include $_SERVER['DOCUMENT_ROOT'].'/test-incident/view-ti.php';
echo dispti(1);
