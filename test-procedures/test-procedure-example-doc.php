...
$userid = 1;
   $docidentifier = 3;
     $gid = 1;
  $pid = 1;
  $docname = "Test Procedure Template Example";
...
<head>
  ...
  <title>ISTM INDEPENDENT SOFTWARE TESTING MODEL TEST PROCEDURE EXAMPLE</title>
  <meta name="description" content="SOFTWARE TESTING TEST PROCEDURE EXAMPLE AND TEMPLATE">
