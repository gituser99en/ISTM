...
<?php
include $_SERVER['DOCUMENT_ROOT'].'/test-procedures/test-procedures-example/display-doc-id.php';
echo dispdocid();
...
?>
     ...
     <div class="flex-cont-50"> 
   <?php
include $_SERVER['DOCUMENT_ROOT'].'/test-procedures/test-procedures-example/display-test-procedures-info.php';
echo dispprocinf();
...
<?php
include $_SERVER['DOCUMENT_ROOT'].'/test-procedures/test-procedures-example/display-field-label.php';
echo dispfieldlabel();
...
<?php
include $_SERVER['DOCUMENT_ROOT'].'/test-procedures/test-procedures-example/display-section.php';
echo displaysection();
...
?>
<?php
include $_SERVER['DOCUMENT_ROOT'].'/test-condition/test-condition-example/display-field-label-mi.php';
