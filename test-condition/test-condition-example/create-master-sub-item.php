...
$sql = "INSERT INTO test_condition_master_sub_field (name, uid, project, ver, stat, owner, userid, docid, location, description, priority) VALUES ('$name', '$uid', '$project', '$version', '$status', '$owner', '$userid', '$docid', '$location' , '$desc1' , '$prio1')";
