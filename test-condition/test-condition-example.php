<?php
session_start();
//function disptestcondition($userid, $docidentifier, $gid, $pid, $docname){

$userid = 1;
$docidentifier = 2;
 $gid = 1;
$pid = 1;
$docname = "ISTM Test Condition";
...
<head>
  ...
  <title>ISTM INDEPENDENT SOFTWARE TESTING MODEL TEST CONDITION EXAMPLE</title>
  <meta name="description" content="SOFTWARE TESTING TEST CONDITION EXAMPLE AND TEMPLATE">
  <meta name="Eric Neilson" content="Eric Neilson">

  <link rel="stylesheet" href="http://www.istm.online/dev/generate-doc/test-condition/tc-form.css?v=1.0">
...
include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/test-condition/display-doc-id.php';
echo dispdocid($docidentifier);


include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/test-condition/display-field-label-ins.php';
include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/test-condition/display-field-label.php';
  include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/test-condition/display-field-label-upd.php';
echo dispfieldlabel();


include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/test-condition/display-section.php';
...
include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/test-condition/display-field-label-mi.php';
  include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/test-condition/display-field-label-miupd.php';
  include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/test-condition/display-field-label-miins.php';
echo dispfieldlabelmiins();
//<form action="/dev/generate-doc/test-condition/create-master-item.php" method="post">
echo'
<form action="/test-condition/tc-example-redirect.php" method="post">

  <div class="flex-cont-la">
<div class="tbf-field">
                <div class="tbf-field-name-ins">
  ...
  <div class="tbf-field-priority-ins">
...
//<form action="/dev/generate-doc/test-condition/create-sub-field.php" method="post">
echo'
<form action="/test-condition/tc-example-redirect.php" method="post">
...
echo dispfieldlabelmiupd();
//<form action="/dev/generate-doc/test-condition/update-master-item.php" method="post">
echo'
<form action="/test-condition/tc-example-redirect.php" method="post">
...
echo dispfieldlabelupd();
//<form action="/dev/generate-doc/test-condition/update-sub-item.php" method="post">
echo'
<form action="/test-condition/tc-example-redirect.php" method="post">
...
//<form action="/dev/generate-doc/test-condition/delete-master-item.php" method="post">
echo'
<form action="/test-condition/tc-example-redirect.php" method="post">
...
<h3>DELETE SUB ITEM</h3>
  ...
  //<form action="/dev/generate-doc/test-condition/delete-sub-item.php" method="post">
  echo'
  <form action="/test-condition/tc-example-redirect.php" method="post">
