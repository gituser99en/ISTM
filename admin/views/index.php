...
<div class="flex-cont">
 <?php
include $_SERVER['DOCUMENT_ROOT'].'/inc/func/viewprojectbyuser.php';
echo viewprojbyuser(1);
...
<div class="flex-cont">
 <?php
include $_SERVER['DOCUMENT_ROOT'].'/inc/func/viewdoctype.php';
echo viewdoctype();
...
<div class="flex-cont">
 <?php
include $_SERVER['DOCUMENT_ROOT'].'/inc/func/viewdoctypebyid.php';
echo viewdoctypebyid();
