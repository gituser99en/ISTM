...
<head>
  ...
  <meta name="description" content="LIST OF SOFTWARE TESTING DOCUMENTS ARTIFACTS AND ASSETS">
...
<div class="flex-cont">
<h1>ISTM SOFTWARE TESTING DOCUMENTS ARTIFACTS AND ASSETS</h1> 
</div> 
...
<br></br>
  ...
  <dl>
  <dt style="
    background-color:rgb(110, 136, 169);  color:white; font-weight: 700;
">Analysis</dt>
    <dt>Company Analysis Form</dt>
  <dd>Form that contains a list of company analysis questions and recorded data.</dd>
  ...
  <dd>Form that contains a list of product analysis questions and recorded data.</dd>
    <dt>Release Analysis Form</dt>
  <dd>Analysis of a specific scheduled release to test.</dd>
  ...
  <dt style="
    background-color:rgb(110, 136, 169);  color:white; font-weight: 700;
">Test Planning and Management</dt>
  <dt>Test Policy</dt>
  ...
  <dd>Test effort and estimation.</dd>
     <dt>Test Condition Estimation Form</dt>
  <dd>Test effort and estimation.</dd>
</dl>
...
">Process Improvement</dt>
     <dt>Incident Form</dt>
  <dd>Form recording all incidents encoutered.</dd>
  <dt>Post Mortem</dt>
...
">General</dt>
  ...
  <dt style="
    background-color:rgb(110, 136, 169); color:white; font-weight: 700;
">General</dt>
  <dt>Test Submission Request Form</dt>
  <dd>Document submitted by development to schedulea test cycle.</dd>
  <dt>V-Modal Diagram</dt>
  <dd>Graphical representation of the V-Model.</dd>
     <dt>Glossary</dt>
  <dd>Document defining all testing terms.</dd>
    <dt>Test Exit Form</dt>
  <dd>Document submitted if test execution fails due to critical issue.</dd>
    <dt>Schedule</dt>
  <dd>Basic ISTM schedule.</dd>
   <dt>ISTM User Manual</dt>
  <dd>User Manual.</dd>
  </dl>
  </div> 
  </div> 
