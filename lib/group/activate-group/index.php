...
<div class="flex-cont">
<?php
  include $_SERVER['DOCUMENT_ROOT'].'/lib/group/get-user-active-groupid.php';
  echo getuseractivegroupid(1);
  
 // include $_SERVER['DOCUMENT_ROOT'].'/lib/group/activate-group/setnewactivegroupstatus.php';
//  echo setnewactivegroupstatus(1, 11, 1);
  
 // include $_SERVER['DOCUMENT_ROOT'].'/lib/group/activate-group/setnewgroupstatus.php';
 // setnewgroupstatus(1, 1);
  
 // include $_SERVER['DOCUMENT_ROOT'].'/lib/group/activate-group/setoldgroupstatus.php';
// echo setoldgroupstatus(1, 1);
  
   include $_SERVER['DOCUMENT_ROOT'].'/lib/group/activate-group/set-group-inactive.php';
 echo setgroupinactive(1, 11);
  include $_SERVER['DOCUMENT_ROOT'].'/lib/group/activate-group/set-group-active.php';
 echo setgroupactive(1, 1);
  ?>
...
<div class="flex-cont">
<?php
  include $_SERVER['DOCUMENT_ROOT'].'/lib/group/get-user-groups-ids.php';
  echo getusergroupsids(1);
  ?>
