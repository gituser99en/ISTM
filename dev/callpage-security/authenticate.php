...
if ($stmt->num_rows > 0) {
	...
	// if (password_verify($_POST['password'], $password)) {
		...
		$_SESSION['loginid'] = $id;
          ...
          $link1="userid=";
           $link2="&tpeoffset=";
          $cpstring = $link1.$id.$link2.$tpeoffset ;
          
		//$_SESSION['escortid'] = $id;
	//	$_SESSION['regionid'] = return_regionid($id);
		//header('Location:/home/home.php');//echo 'Welcome ' . $_SESSION['name'] . '!';
          header("Location:/dev/callpage-security/callpagehome.php?$cpstring");
          // header("Location:/dev/callpage-security/callpagehome.php?userid=$id&tpeoffset=$tpeoffset");
	} else {
