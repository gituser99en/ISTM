...
<div class="flex-cont-r">
<div class="flex-cont-69">
<p>2 columns 69 and 29</p>
</div> 
...
<div class="flex-cont-r">
  ...
  <div>
  <?php
include $_SERVER['DOCUMENT_ROOT'].'/dev/listdocs/doc-list.php';
echo doclist();
...
?>
 ...
 <div class="flex-cont-29"> 
  <div>
  <?php
include $_SERVER['DOCUMENT_ROOT'].'/dev/listdocs/doc-list-type.php';
echo doclisttype(1, 3);
