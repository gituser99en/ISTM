...
function tptcdid($userid, $gid, $pid, $dtid, $dtname, $doctypeid, $tptid){
...
';
  ...
  echo'
<form action="create-docid-tpt.php" method="post">
...
<div class="di-field">
                ...
                <div class="di-field-cont">
              <input type="text" name="sourcename" placeholder="sourcename" id="sourcename" required>
               </div> 
</div> 
</div>
...
<div class="di-field">
                ...
                <div class="di-field-cont">
              <input type="text" name="sourceuid" placeholder="sourceuid" id="sourceuid" required>
               </div> 
</div> 
</div> 
<div class="flex-cont-la">
<div class="di-field">
                ...
                <div class="di-field-cont">
              <input type="text" name="tcc" placeholder="tcc" id="tcc" required>
               </div> 
</div> 
</div> 
...
<input type="hidden" name="tptid" id="tptid" value="'; echo $tptid;  echo'">
