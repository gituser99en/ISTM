...
function disptestreport($userid, $docidentifier, $gid, $pid, $docname, $doctypeid){
...
<head>
  ...
  <link rel="stylesheet" href="http://www.istm.online/dev/generate-doc/test-reports/test-report/istm.css?v=1.0">
...
include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/test-reports/test-report/display-doc-id.php';
echo dispdocid($docidentifier);

echo' <div class="red-header">
<p>Critical Issues</p>
</div> 
';
include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/test-reports/test-report/display-sectionr.php';
echo displaysectionr($docidentifier);
...
';
include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/test-reports/test-report/display-sectiony.php';
echo displaysectiony($docidentifier);
...
';
include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/test-reports/test-report/display-sectiong.php';
echo displaysectiong($docidentifier);
...
';
include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/test-reports/test-report/display-sectionblu.php';
echo displaysectionblu($docidentifier);
...
';
include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/test-reports/test-report/display-sectionbla.php';
echo displaysectionbla($docidentifier);
...
//echo dispfieldlabelmi();
  ...
  echo'
<form action="/dev/generate-doc/test-reports/test-report/create-red-item.php" method="post">
...
<div class="tbf-field">
                ...
                <input type="text" name="description" placeholder="description" id="description" required>
                 ...
                 <input type="text" name="severity" placeholder="Severity" id="severity" required>
                 </div> 
                 <div class="tbf-field-version">
               <input type="text" name="ts" placeholder="Timestamp"id="ts" required>
                 </div> 
