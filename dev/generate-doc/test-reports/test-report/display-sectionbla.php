...
function displaysectionbla($did){
...
//select
$sql1 = "SELECT * FROM test_report_blue WHERE did ='$did'";
...
{
 // echo'<div class="black-issue">';
    echo' <table style="width:100%; border:1px solid; border-color:black">';
echo "<tr>";
