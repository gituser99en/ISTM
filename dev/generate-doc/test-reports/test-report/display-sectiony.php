...
//select
$sql1 = "SELECT * FROM test_report_green WHERE did ='$did'";
...
{
 // echo'<div class="yellow-issue">';
   echo' <table style="width:100%; border:1px solid; border-color:yellow">';
echo "<tr>";
