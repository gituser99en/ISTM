...
function displaysectione($dtid, $did, $gid, $pid, $userid, $docname){
...
include $_SERVER['DOCUMENT_ROOT'].'/inc/db/db.php';
 // include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/test-procedure/display-test-procedure-field.php';
  include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/test-procedure/display-test-procedure-field-execution.php';
...
//select
$sql1 = "SELECT * FROM test_procedure_title WHERE docid ='$dtid'";
...
';
     echo displayfieldtpe($dtid, $did, $tpid, $gid, $pid, $userid, $docname);
