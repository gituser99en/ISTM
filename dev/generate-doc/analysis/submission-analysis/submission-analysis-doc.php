...
function dispsubanal($userid, $docidentifier, $gid, $pid, $docname){

  include $_SERVER['DOCUMENT_ROOT'].'/inc/func/checkgeneratesubanalysis.php';
  include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/analysis/submission-analysis/gensaq.php';


  
  $docstatus = csagen($docidentifier);
  if ($docstatus == 0){
 echo gensaq($gid, $pid, $docidentifier);
  }
...
include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/analysis/submission-analysis/viewsubanalysisdetails.php';
echo viewsubanalysisdetails1(1, 1, $docidentifier);
