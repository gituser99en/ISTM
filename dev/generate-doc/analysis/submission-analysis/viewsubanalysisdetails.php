...
function viewsubanalysisdetails1($gid, $pid, $did){
...
//$sql1 = "SELECT * FROM analysis_test";
  $sql1 = "SELECT analysis_sub.id, analysis_sub.name, analysis_sub.description, document_submission_analysis.inserted_data  FROM analysis_sub INNER JOIN document_submission_analysis ON analysis_sub.id = document_submission_analysis.qid WHERE document_submission_analysis.did ='$did'";
