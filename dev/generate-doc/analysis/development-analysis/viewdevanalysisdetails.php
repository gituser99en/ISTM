...
function viewdevelopmentanalysisdetails1($gid, $pid, $did){
...
//$sql1 = "SELECT * FROM analysis_test";
  $sql1 = "SELECT analysis_dev.id, analysis_dev.name, analysis_dev.description, document_development_analysis.inserted_data  FROM analysis_dev INNER JOIN document_development_analysis ON analysis_dev.id = document_development_analysis.qid WHERE document_development_analysis.did ='$did'";
