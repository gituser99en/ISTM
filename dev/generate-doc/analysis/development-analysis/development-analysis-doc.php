...
function dispdevanal($userid, $docidentifier, $gid, $pid, $docname){

  include $_SERVER['DOCUMENT_ROOT'].'/inc/func/checkgeneratedevelopmentanalysis.php';
  include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/analysis/development-analysis/gendaq.php';


  
  $docstatus = cdagen($docidentifier);
  if ($docstatus == 0){
 echo gendaq($gid, $pid, $docidentifier);
  }
...
include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/analysis/development-analysis/viewdevanalysisdetails.php';
echo viewdevelopmentanalysisdetails1(1, 1, $docidentifier);
