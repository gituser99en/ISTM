...
function dispproanal($userid, $docidentifier, $gid, $pid, $docname){

  include $_SERVER['DOCUMENT_ROOT'].'/inc/func/checkgenerateproanalysis.php';
  include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/analysis/project-analysis/genpaq.php';


  
  $docstatus = cpagen($docidentifier);
  if ($docstatus == 0){
 echo genpaq($gid, $pid, $docidentifier);
  }
...
include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/analysis/project-analysis/viewproanalysisdetails.php';
echo viewproanalysisdetails1(1, 1, $docidentifier);
