...
function dispcomanal($userid, $docidentifier, $gid, $pid, $docname){

  include $_SERVER['DOCUMENT_ROOT'].'/inc/func/checkgeneratecomanalysis.php';
  include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/analysis/company-analysis/gencaq.php';


  
  $docstatus = ccagen($docidentifier);
  if ($docstatus == 0){
 echo gencaq($gid, $pid, $docidentifier);
  }
...
include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/analysis/company-analysis/viewcomanalysisdetails.php';
echo viewcomanalysisdetails1(1, 1, $docidentifier);
