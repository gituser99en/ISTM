...
function viewcomanalysisdetails1($gid, $pid, $did){
...
//$sql1 = "SELECT * FROM analysis_test";
  $sql1 = "SELECT analysis_co.id, analysis_co.name, analysis_co.description, document_company_analysis.inserted_data  FROM analysis_co INNER JOIN document_company_analysis ON analysis_co.id = document_company_analysis.qid WHERE document_company_analysis.did ='$did'";
