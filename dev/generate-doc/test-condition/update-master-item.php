...
$sql = "UPDATE test_condition_master_field SET name = '$name', uid = '$uid', description = '$desc', priority = '$priority', project = '$project', ver = '$version', stat = '$status', owner = '$owner', userid = '$userid', docid = '$doctypeid', location = '$location' WHERE uid = '$uid' AND docident = '$docid' ";
