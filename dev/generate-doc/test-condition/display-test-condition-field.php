...
function displayfield($did1, $suid1){
...
//select
  $sql2 = "SELECT * FROM test_condition_field WHERE docident = '$did1' AND uid LIKE '$suid1%' ORDER BY uid";
//$sql2 = "SELECT * FROM test_condition_field WHERE docident = '$did1' AND uid LIKE '$suid1%'";
