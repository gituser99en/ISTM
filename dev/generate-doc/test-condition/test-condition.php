...
<?php
include $_SERVER['DOCUMENT_ROOT'].'/test-condition/test-condition-example/display-doc-id.php';
echo dispdocid();
...
<?php
include $_SERVER['DOCUMENT_ROOT'].'/test-condition/test-condition-example/display-field-label.php';
echo dispfieldlabel();

?>
  
<?php
include $_SERVER['DOCUMENT_ROOT'].'/test-condition/test-condition-example/display-section.php';
echo displaysection();
