...
$sql = "INSERT INTO test_condition_master_field (name, uid, project, ver, stat, owner, userid, docid, location, description, priority, gid, pid, docident) VALUES ('$name', '$uid', '$project', '$version', '$status', '$owner', '$userid', '$doctypeid', '$location' , '$desc1' , '$prio1','$gid', '$pid', '$docid')";
