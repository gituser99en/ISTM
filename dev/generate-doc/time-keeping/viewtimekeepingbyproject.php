...
//select
$sql1 = "SELECT time_keeping.pid, time_keeping.username, time_keeping.activityid, time_keeping_activity.name, time_keeping.timeinmin,time_keeping.ts FROM time_keeping INNER JOIN time_keeping_activity ON time_keeping.activityid = time_keeping_activity.id WHERE time_keeping.pid = 1";
