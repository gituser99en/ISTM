...
if (!isset($_SESSION['tpeoffset']))
{
  $_SESSION['tpeoffset'] = "0";
}
...
//function disphpme($userid, $docidentifier, $gid, $pid, $docname, $doctypeid){
  function disphome($userid, $tpeoffset){
...
function showDocumentcat(str) {
  ...
  xhttp.open("GET", "../dct.php?q="+str, true);
  xhttp.send();
}
  </script>
...
function showDocumentbycat(str) {
  ...
  xhttp.open("GET", "../dbct.php?q="+str, true);
  xhttp.send();
}
  </script>
  <script>
function showDocumentbycattpt(str) {
  ...
  xhttp.open("GET", "../dtpe.php?q="+str, true);
  xhttp.send();
}
  </script>
...
<div class="header">   
	<div class="headerimg">
		<img alt="ISTM INDEPENDENT SOFTWARE TESTING MODEL"  img src="http://www.istm.online/inc/img/ISTM350.jpg" >
	</div> 
</div> 

<div class="flex-cont">
<h1>'; echo $_SESSION['name']; echo' Home Page</h1> 
</div> 
...
echo'
  ...
  <div>
';
//echo doccat(5, $_SESSION['uprojid']);
  //  echo doccattpt(21, $_SESSION['uprojid']);
...
echo'
     ...
     echo'
<button onclick="document.location=';echo"'http://www.istm.online/dev/generate-doc/home/callpagehome.php?userid="; echo $userid; echo"&docidentifier=";echo $did; echo"&gid="; echo $gid; echo"&pid="; echo $pid; echo"&docname="; echo $name; echo"&doctype="; echo $dtid; echo"&sbid=2"; echo"'"; echo'">HOME</button>
';
    echo'
    </div> 
...
//echo doccattpep(5, $_SESSION['uprojid'], 0);
   include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/home/tpepagination.php';
   // $tpeoffset=10;
echo tpepagination($tpeoffset);
//echo doccattpe(5, $_SESSION['uprojid']);
$tpeoffsettotalnp= $tpeoffset + 10;
    $tpeoffsettotalpp= $tpeoffset - 10;

echo'
    </div> ';
     echo'
     <div>
<button onclick="document.location=';echo"'http://www.istm.online/dev/generate-doc/home/callpagehome.php?userid="; echo $userid; echo"&tpeoffset=";echo $tpeoffsettotalnp;echo"&docidentifier=";echo $did; echo"&gid="; echo $gid; echo"&pid="; echo $pid; echo"&docname="; echo $name; echo"&doctype="; echo $dtid; echo"&sbid=2"; echo"'"; echo'">NEXT</button>
';
     echo'
<button onclick="document.location=';echo"'http://www.istm.online/dev/generate-doc/home/callpagehome.php?userid="; echo $userid; echo"&tpeoffset=";echo $tpeoffsettotalpp;echo"&docidentifier=";echo $did; echo"&gid="; echo $gid; echo"&pid="; echo $pid; echo"&docname="; echo $name; echo"&doctype="; echo $dtid; echo"&sbid=2"; echo"'"; echo'">PREVIOUS</button>
';
    echo'
    </div>
    </div> 
...
echo'
 ...
 <div class="flex-cont-r" style="border-top: 1px solid;
   ...
   GENERATE DOCUMENT';
    include_once $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/doctypecatergorydd.php'; echo dispdoctypecatergorydd();  
  echo'    
  <div id="txtHintdoc1">
...
echo dispuserdet($_SESSION['userid']);
...
echo dispprojuserdet2($_SESSION['userid']);
...
echo dispuserprojdet($_SESSION['userid']);
...
echo dispprojuserdet1($_SESSION['userid']);


echo'
  </div>
  
  <div class="flex-cont-na">
  	<div class="flex-cont-na" style="width:50%; align-items:;">
    '; include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/home/displayusergroups.php';
    echo displayusergroups($_SESSION['userid']);
    echo'
    </div> 
    <div class="flex-cont-na" style="width:50%; align-items:;">';
    include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/home/displayuserprojects.php';
    echo displayuserprojects($_SESSION['userid']);
    echo'
 </div> 
