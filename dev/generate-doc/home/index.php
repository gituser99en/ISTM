...
if (!isset($_SESSION['uprojid']))
{
  $_SESSION['uprojid'] = "null";;
}
...
<div class="dropdown-content">
  ...
  <a href="http://www.istm.online/messages/page-under-construction.php">Fundamentals</a>
<a href="http://www.istm.online/messages/page-under-construction.php">Life Cycle</a>
<a href="http://www.istm.online/messages/page-under-construction.php">Test Levels</a>
 <a href="http://www.istm.online/messages/page-under-construction.php">Test Types</a>
<a href="http://www.istm.online/messages/page-under-construction.php">Test Design</a>
  <a href="http://www.istm.online/messages/page-under-construction.php">Static</a>
<a href="http://www.istm.online/messages/page-under-construction.php">Test Management</a>
  <a href="http://www.istm.online/messages/page-under-construction.php">Test Metrics</a>
...
<div class="flex-cont">
  ...
  $tpeoffset=0;
  echo'
<button onclick="document.location=';echo"'http://www.istm.online/dev/generate-doc/home/callpagehome.php?userid="; echo $userid; echo"&tpeoffset=";echo $tpeoffset; echo"&docidentifier=";echo $did; echo"&gid="; echo $gid; echo"&pid="; echo $pid; echo"&docname="; echo $name; echo"&doctype="; echo $dtid; echo"&sbid=2"; echo"'"; echo'">HOME</button>
';
 //  echo'
//<button onclick="document.location=';echo''http://www.istm.online/dev/generate-doc/home/callpagehome.php?userid="; echo $userid; echo'"; echo'">HOME</button>
//';
  ?>
</div> 
