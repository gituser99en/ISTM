...
$sql = "UPDATE test_basis_field SET name = '$name', uid = '$uid', type = '$type', project = '$project', ver = '$version', stat = '$status', owner = '$owner', userid = '$userid', docid = '$docid', location = '$location' WHERE uid = '$uid' AND docid = '$docid' AND id = '$id' ";
