...
$sql = "INSERT INTO test_basis_master_field (name, uid, type, project, ver, stat, owner, userid, docid, location, gid, pid, dtid) VALUES ('$name', '$uid', '$type',  '$project', '$version', '$status', '$owner', '$userid', '$doctypeid', '$location', '$gid', '$pid', '$dtid')";
