...
function viewincidentformdetails1($gid, $pid, $did, $userid, $dtid, $sbid, $name){
...
//select
$sql1 = "SELECT * FROM document_incident_form WHERE did ='$did'";
...
echo '<th width="5%" style="
    ...
    <button onclick="document.location=';echo"'http://www.istm.online/dev/generate-doc/callpage.php?userid="; echo $userid; echo"&docidentifier=";echo $did; echo"&gid="; echo $gid; echo"&pid="; echo $pid; echo"&docname="; echo $name; echo"&doctype="; echo $dtid; echo"&sbid=1"; echo"'"; echo'">ID</button>
