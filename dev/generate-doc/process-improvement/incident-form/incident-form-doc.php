...
function dispincidentform($userid, $docidentifier, $gid, $pid, $docname, $doctypeid, $sbid){

 // include $_SERVER['DOCUMENT_ROOT'].'/inc/func/checkgeneratetestanalysis.php';
 // include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/process-improvement/test-analysis/gentaq.php';
include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/process-improvement/test-analysis/create-incident-item.php';
...
include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/process-improvement/incident-form/display-doc-id.php';
echo dispdocid($docidentifier);


//include $_SERVER['DOCUMENT_ROOT'].'/inc/func/document/incident-form/viewincidentformdetails.php';
//echo viewincidentformdetails();

//include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/process-improvement/incident-form/viewincidentformdetails.php';
//echo viewincidentformdetails1(1, 1, $docidentifier);
  
  include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/process-improvement/incident-form/sortbyfunc.php';
echo sortbyf(1, 1, $docidentifier, $userid, $doctypeid, $sbid, $docname);
...
<div class="flex-cont">
<h3>INSERT INCIDENT</h3>
</div> 
';
//include $_SERVER['DOCUMENT_ROOT'].'/dev/generate-doc/process-improvement/incident-form/display-field-label.php';
//echo dispfieldlabel();

echo'
<form action="/dev/generate-doc/process-improvement/incident-form/create-incident-item.php" method="post">
...
<div class="tbf-field">
                ...
                <input type="text" name="description" placeholder="description" id="description" required>
                 ...
                 <div class="tbf-field-catergory">
                <input type="text" name="catergory" placeholder="catergory" id="catergory" required>
                 </div> 
                ...
                <input type="hidden" id="gid" name="gid" value="'; echo $gid; echo'">
  				<input type="hidden" id="pid" name="pid" value="'; echo $pid; echo'">
                <input type="hidden" id="dtid" name="dtid" value="'; echo $doctypeid; echo'">
